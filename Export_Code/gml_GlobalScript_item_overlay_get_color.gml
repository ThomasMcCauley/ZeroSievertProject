function item_overlay_get_color(argument0) //gml_Script_item_overlay_get_color
{
    var _struct = global.overlay_item
    switch argument0
    {
        case "weight":
            var _min = _struct.weight_min
            var _max = _struct.weight_max
            var _color = [0, 1, 2, 3, 4]
            var _value = item_get_weight(__lootStruct.item) * __lootStruct.quantity
            break
        case "value":
