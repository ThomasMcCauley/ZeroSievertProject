...
*/
function uiFileCheckForChanges(argument0) //gml_Script_uiFileCheckForChanges
{
    return gml_Script___uiFileEnsure(argument0).gml_Script___uiFileEnsure(argument0).__CheckForChanges();
}
