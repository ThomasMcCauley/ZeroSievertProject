function scr_npc_get_ammo_drop(argument0, argument1) //gml_Script_scr_npc_get_ammo_drop
{
    var _value = npc_get_ammo_value(argument1)
    var _caliber = item_ammo_get_caliber(argument0)
    var _new_ammo_drop = argument0
    switch _caliber
    {
        case "a9x18":
            switch _value
        ...
        case "a12x70":
            switch _value
            {
                ...
                case 2:
                    ...
                    break
                case 3:
                    _new_ammo_drop = choose("ammo_12x70", "ammo_12x70_slug_ap")
                    break
                case 4:
                    _new_ammo_drop = "ammo_12x70_slug_ap"
                    break
            }
