/*
WARNING: Recursive script decompilation (for member variable name resolution) failed for gml_Script_trader_item_get_quantity
...
*/
/*
WARNING: Recursive script decompilation (for member variable name resolution) failed for gml_Script_trader_item_get_chance
...
*/
/*
WARNING: Recursive script decompilation (for member variable name resolution) failed for gml_Script_trader_item_get_quest
...
*/
/*
WARNING: Recursive script decompilation (for member variable name resolution) failed for gml_Script_trader_item_get_level
...
*/
/*
WARNING: Recursive script decompilation (for asset type resolution) failed for gml_Script_trader_item_get_level
...
*/
/*
WARNING: Recursive script decompilation (for asset type resolution) failed for gml_Script_trader_item_get_quest
...
*/
/*
WARNING: Recursive script decompilation (for asset type resolution) failed for gml_Script_trader_item_get_chance
...
*/
/*
WARNING: Recursive script decompilation (for asset type resolution) failed for gml_Script_trader_item_get_quantity
...
if (npc_get_trader_id(npc_id) != "no_trader")
{
    ...
    else
    {
        ...
        db_open("general")
        money_trader = floor(trader_get_money(_trader_id) * (global.sk_k[(22 << 0)]))
