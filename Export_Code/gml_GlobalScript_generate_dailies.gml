var _pool;
function generate_dailies() //gml_Script_generate_dailies
{
    ...
    if (global.daily_quest_generated == false)
    {
        ...
        _pool[_i] = 
        {
            ...
            pool: [new class_daily_kill(global.quest_kill_array.bandit, "Bandits", 5, 1, -1, 3, 0, 3, 3), new class_daily_kill(["ghoul"], "", 5, 1, -1, 3, 0, 3, 3), new class_daily_kill(["wolf_brown"], "Wolf", 5, 1, -1, 2, 0, 2, 2), new class_daily_kill(["boar"], "", 2, 1, [(1 << 0), (2 << 0), (3 << 0)], 3, 0, 2, 2), new class_daily_kill(["blink"], "", 3, 3, [(3 << 0), (4 << 0), (6 << 0)], 3, 0, 2, 2), new class_daily_kill(["big"], "", 1, 3, [(4 << 0), (6 << 0)], 0, 0, 1, 1), new class_daily_kill(global.quest_kill_array.hunter, "Hunters", 2, 1, -1, 2, 0, 4, 4), new class_daily_kill(["spider"], "", 4, 3, [(3 << 0), (4 << 0)], 2, 0, 1, 1), new class_daily_kill(["bandit_boss"], "", 1, 1, [(1 << 0)], 1, 0, 0, 0), new class_daily_kill(["arman"], "", 1, 3, [(2 << 0)], 0, 0, 1, 1), new class_daily_kill(["killa"], "", 1, 4, [(6 << 0)], 1, 0, 1, 1), new class_daily_kill(global.quest_kill_array.green_army, "Green Army soldier", 3, 1, -1, 0, 0, 0, 4), new class_daily_kill(global.quest_kill_array.crimson, "CC soldier", 3, 1, -1, 0, 0, 4, 0)]
        }
        ...
        _pool[_i] = 
        {
            ...
            pool: [new class_daily_contract(301, "Bandit", -1, 1, 3, 0, 1, 0), new class_daily_contract(302, "Bandit", -1, 1, 3, 0, 1, 0), new class_daily_contract(309, "Big", -1, 3, 1, 0, 1, 0), new class_daily_contract(833, "Hunter", -1, 1, 1, 0, 4, 1), new class_daily_contract(834, "Hunter", -1, 1, 1, 0, 4, 1), new class_daily_contract(310, "Infestation", -1, 1, 0, 3, 0, 2), new class_daily_contract(816, "Green Army soldier", -1, 1, 0, 0, 0, 5), new class_daily_contract(822, "CC soldier", -1, 1, 0, 0, 5, 0)]
        }
        ...
        _pool[_i] = 
        {
            ...
            pool: [new class_daily_survive((1 << 0), 2, 1, 1, 1, 0, 0), new class_daily_survive((2 << 0), 2, 1, 1, 1, 1, 1), new class_daily_survive((3 << 0), 1, 3, 1, 1, 1, 1), new class_daily_survive((4 << 0), 1, 3, 0, 1, 1, 1), new class_daily_survive((6 << 0), 1, 3, 0, 0, 1, 1)]
        }
        ...
        _pool[_i] = 
        {
            ...
            pool: [new class_daily_survive_exp([(1 << 0), (2 << 0), (3 << 0), (4 << 0), (6 << 0)], 2, 1, 125, 1, 1, 1, 1), new class_daily_survive_exp(-1, 2, 1, 125, 1, 1, 1, 1)]
        }
        ...
        _pool[_i] = 
        {
            ...
            pool: [new class_daily_survive_money([(1 << 0), (2 << 0), (3 << 0), (4 << 0), (6 << 0)], 2, 1, 7500, 1, 1, 1, 1), new class_daily_survive_money(-1, 2, 1, 7500, 1, 1, 1, 1)]
        }
        ...
        _pool[_i] = 
        {
            ...
            pool: [new class_daily_retrieve_analyzer((11 << 0), "quest_retrive_analyzer_anomaly_fire_medium", 452, 1, undefined, 0, 3, 0, 0), new class_daily_retrieve_analyzer((12 << 0), "quest_retrive_analyzer_anomaly_fire_big", 536, 1, undefined, 0, 3, 0, 0), new class_daily_retrieve_analyzer((15 << 0), "quest_retrive_analyzer_anomaly_gas_big", 72, 1, undefined, 0, 3, 0, 0), new class_daily_retrieve_analyzer((14 << 0), "quest_retrive_analyzer_anomaly_gas_medium", 100, 1, undefined, 0, 3, 0, 0)]
        }
        ...
        _pool[_i] = 
        {
            ...
            pool: [new class_daily_place_analyzer((11 << 0), 1, undefined, 208, 0, 3, 0, 0), new class_daily_place_analyzer((12 << 0), 1, undefined, 6, 0, 3, 0, 0), new class_daily_place_analyzer((15 << 0), 1, undefined, 954, 0, 3, 0, 0), new class_daily_place_analyzer((14 << 0), 1, undefined, 17, 0, 3, 0, 0)]
        }
        ...
        _pool[_i] = 
        {
            ...
            pool: [new class_daily_retrieve_equipment("Crimson Corporation", "quest_retrieve_equipment_1", 109, 1, -1, 0, 0, 0, 3), new class_daily_retrieve_equipment("Green Army", "quest_retrieve_equipment_2", 166, 1, -1, 0, 0, 3, 0)]
        }
        ...
        for (i = 0; i < 8; i++)
        {
            if (_create_new[i] == false)
            {
                ...
                for (j = 0; j < array_length(_array_objective); j++)
                {
        ...
        for (i = 0; i < 8; i++)
        {
            if (_create_new[i] == true)
            {
                ...
                {
                    case 0:
                        var _text = "A lone raider needs a job doing."
                        break
                    case 1:
                ...
                for (j = 0; j < _n_objectives; j++)
                {
                    ...
                    while (_already_generated == true)
                    {
                        ...
                        var _quest_type_selected = _pool[_pool_index].type
                        var _array_sub_pool = _pool[_pool_index].pool
                        var _array_chance2 = []
                        for (k = 0; k < array_length(_array_sub_pool); k++)
                        {
                            if (_user_lvl >= _array_sub_pool[k].lvl_min)
                            {
                                ...
                                {
                                    case "Loners":
                                        var _pool_index_chance_faction = _array_sub_pool[k].chance_loner
                                        break
                                    case "Scientists":
                        ...
                        {
                            var _sub_pool_entry = _array_chance2[irandom(array_length(_array_chance2) - 1)]
                    ...
                    switch _quest_type_selected
                    {
                        case "kill":
                            ...
                            var _struct_objective = new quest_create_kill(_amount_to_kill, _struct_sub_pool.name, _choosed_quest_map, _struct_sub_pool.object)
                        ...
                        case "collect":
                            ...
                            _diff_multiplier = 1 + _diff_default / 2
                            ...
                            _quest_reward_money += round(item_get_value(_item_to_collect) * _amount_to_collect * gml_Script_difficulty_get("trade_sell_mult") * 0.75)
                            _quest_reward_exp += round(10 * _diff_multiplier)
                            break
                        case "contract":
                            var _kill_obj_instance = _struct_sub_pool.object
                            _diff_multiplier = 1 + _diff_default * 2 / 10
                            if (_struct_sub_pool.map == -1)
                            {
                                if (_user_lvl < 3)
                                    _choosed_quest_map = choose((1 << 0), (2 << 0))
                                else
                                    _choosed_quest_map = choose((1 << 0), (2 << 0), (3 << 0), (4 << 0), (6 << 0))
                            }
                            else
                            ...
                            break
                        case "survive":
                            _diff_multiplier = 1 + _diff_default / 4
                            _choosed_quest_map = _struct_sub_pool.map
                            ...
                            break
                        case "survive_exp":
                            _diff_multiplier = (1 + _diff_default / 3) * (random_range(0.8, 1.2))
                            if (_struct_sub_pool.map != -1)
                        ...
                        case "survive_money":
                            ...
                            break
                        case "retrieve_analyzer":
                            _diff_multiplier = 1 + _diff_default
                            if (_struct_sub_pool.map == -1)
                                _choosed_quest_map = daily_return_map()
                            else
                        ...
                        case "place_analyzer":
                            ...
                            if (_struct_sub_pool.map == -1)
                                ...
                                _choosed_quest_map = irandom(array_length(_struct_sub_pool.map) - 1)
                            _ano_id = _struct_sub_pool.ano_id
                            var _dis = place_radius[_ano_id] * 16 / 2
                            var _object_id = _struct_sub_pool.object_id
                            _struct_objective = new quest_create_place_analyzer(_ano_id, _object_id, "scientific_analyzer", _dis, "Place", _choosed_quest_map, (59 << 0), (60 << 0), _object_id, 9)
                        ...
                        case "retrieve_equipment":
                            ...
                            if (_struct_sub_pool.map == -1)
                                ...
                                _choosed_quest_map = irandom(array_length(_struct_sub_pool.map) - 1)
                            _chest_obj = _struct_sub_pool.chest_obj
                            _item_id = _struct_sub_pool.item_id
