function SnapForeach() //gml_Script_SnapForeach
{
    var _ds = argument[0]
    ...
    if is_struct(_ds)
    {
        ...
        {
            var _name = _names[_i]
            self._function(variable_struct_get(_ds, _name), _i, _name)
            _i++
        }
    }
    else if is_array(_ds)
    {
        ...
        {
            self._function(_ds[_i], _i, undefined)
            _i++
        }
    }
    else
    {
        switch _ds_type
        {
            case 2:
                ...
                {
                    self._function(ds_list_find_value(_ds, _i), _i, undefined)
                    _i++
                }
                break
            case 1:
                ...
                {
                    self._function(ds_map_find_value(_ds, _key), _i, _key)
            ...
            case 5:
                ...
                repeat _h
                {
                    ...
                    repeat _w
                    {
                        self._function(ds_grid_get(_ds, _x, _y), _x, _y)
                        _x++
                    }
                    _y++
                }
