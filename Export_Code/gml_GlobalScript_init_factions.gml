...
variable_struct_set(global.struct_faction, "Player", 
{
    id: "Player",
    name: "Player",
    index: 0,
...
variable_struct_set(global.struct_faction, "Loners", 
{
    id: "Loners",
    name: "Loners",
    index: 1,
...
variable_struct_set(global.struct_faction, "Scientists", 
{
    id: "Scientists",
    name: "Scientists",
    index: 4,
...
variable_struct_set(global.struct_faction, "Bandits", 
{
    id: "Bandits",
    name: "Bandits",
    index: 5,
...
variable_struct_set(global.struct_faction, "Mutants", 
{
    id: "Mutants",
    name: "Mutants",
    index: 6,
...
variable_struct_set(global.struct_faction, "Watcher", 
{
    id: "Watcher",
    name: "Watcher",
    index: 9,
