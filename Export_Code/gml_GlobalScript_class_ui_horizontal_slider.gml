...
System.InvalidOperationException: Stack empty.
   ...
   at UndertaleModLib.Decompiler.Decompiler.DirectFunctionCall.DoTypePropagation(DecompileContext context, AssetIDType suggestedType) in D:\a\UndertaleModTool\UndertaleModTool\UndertaleModLib\Decompiler\Instructions\Decompiler.DirectFunctionCall.cs:line 139
*/
gml_Script_uiAddBoxType("UiHorizontalSlider", gml_Script_class_ui_horizontal_slider)
function class_ui_horizontal_slider() constructor //gml_Script_class_ui_horizontal_slider
{
    ...
    self.CallbackSet((13 << 0), function() //gml_Script_anon_class_ui_horizontal_slider_gml_GlobalScript_class_ui_horizontal_slider_2948_class_ui_horizontal_slider_gml_GlobalScript_class_ui_horizontal_slider
    {
        handleWidth = 24
        handleHeight = 60
    ...
    self.CallbackSet((12 << 0), function() //gml_Script_anon_class_ui_horizontal_slider_gml_GlobalScript_class_ui_horizontal_slider_3155_class_ui_horizontal_slider_gml_GlobalScript_class_ui_horizontal_slider
    {
        var _oldValue = value
        ...
        draw_sprite_ext(s_hud_slider_point, ((self.GetHover() && (!uiPointerIsDirectional())) || self.GetButton()), _handleX, _handleY, 4, 4, 0, _color, _alpha)
    }
)
}
