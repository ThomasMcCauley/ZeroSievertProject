function scr_enemy_path() //gml_Script_scr_enemy_path
{
    ...
    if (path_timer >= path_timer_reset)
    {
        ...
        {
            if (human_state_now == (12 << 0) || human_state_now == (13 << 0) || human_state_now == (15 << 0) || human_state_now == (18 << 0) || human_state_now == (17 << 0) || human_state_now == (16 << 0) || human_state_now == (28 << 0) || human_state_now == (26 << 0) || human_state_now == (14 << 0) || human_state_now == (30 << 0) || human_state_now == (29 << 0) || human_state_now == (33 << 0))
                spd = npc_get_spd_alerted(npc_id)
        }
