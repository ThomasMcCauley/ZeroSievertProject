...
*/
function uiPointerGetCaptureY(argument0) //gml_Script_uiPointerGetCaptureY
{
    if (argument0 == undefined)
        argument0 = undefined
    if (argument0 == undefined)
        argument0 = gml_Script___uiRootStackTop()
    return (is_struct(argument0) ? argument0.__root.__captureLocalY : 0);
}
