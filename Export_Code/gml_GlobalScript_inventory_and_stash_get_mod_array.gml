function inventory_and_stash_get_mod_array(argument0, argument1) //gml_Script_inventory_and_stash_get_mod_array
{
    var _result_array = []
    ...
    repeat array_length(_loot_array)
    {
        ...
        if (item_mod_fits_weapon(_item, argument0) && item_mod_fits_position(_item, argument1))
        {
            var _found = false
            var _j = 0
