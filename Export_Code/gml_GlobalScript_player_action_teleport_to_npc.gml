...
*/
function player_action_teleport_to_npc() //gml_Script_player_action_teleport_to_npc
{
    if (is_in_hub() && (!instance_exists(obj_sleep_fade)))
    {
        gml_Script___uiGlobal().__defaultOnion.gml_Script___uiGlobal().__defaultOnion.LayerAddTop("ZS_vanilla/ui/modal_teleport.ui")
        player_set_local_state(gml_Script_scr_player_state_teleport)
        return true;
    }
    return false;
}
