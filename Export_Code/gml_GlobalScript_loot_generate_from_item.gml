...
*/
function loot_generate_from_item(argument0, argument1, argument2, argument3) //gml_Script_loot_generate_from_item
{
    with (argument0)
    {
        var _loot = new class_loot(my_id, qnt, (x + argument1), (y + argument2), rotation, argument3)
