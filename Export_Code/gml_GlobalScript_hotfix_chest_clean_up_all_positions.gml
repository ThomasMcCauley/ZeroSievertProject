...
*/
function hotfix_chest_clean_up_all_positions() //gml_Script_hotfix_chest_clean_up_all_positions
{
    var _c = 0
    repeat db_read_ext("chest", "Storage", "slot now", 2)
    {
        ...
        repeat array_length(_loot_array)
        {
            ...
            {
                var _fixed_position = gml_Script_chest_clean_up_position(_loot.x, _loot.y)
