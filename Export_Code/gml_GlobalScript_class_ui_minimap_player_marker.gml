...
System.InvalidOperationException: Stack empty.
   ...
   at UndertaleModLib.Decompiler.Decompiler.DirectFunctionCall.DoTypePropagation(DecompileContext context, AssetIDType suggestedType) in D:\a\UndertaleModTool\UndertaleModTool\UndertaleModLib\Decompiler\Instructions\Decompiler.DirectFunctionCall.cs:line 139
*/
gml_Script_uiAddBoxType("UiMinimapPlayerMarker", gml_Script_class_ui_minimap_player_marker)
function class_ui_minimap_player_marker() constructor //gml_Script_class_ui_minimap_player_marker
{
    var _temp_local_var_2 = @@CopyStatic@@(gml_Script_uiClassButton)
    var _temp_local_var_3 = uiClassButton()
    self.CallbackSetDraw(function() //gml_Script_anon_class_ui_minimap_player_marker_gml_GlobalScript_class_ui_minimap_player_marker_623_class_ui_minimap_player_marker_gml_GlobalScript_class_ui_minimap_player_marker
    {
