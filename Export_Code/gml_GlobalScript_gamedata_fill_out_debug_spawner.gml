function gamedata_fill_out_debug_spawner() //gml_Script_gamedata_fill_out_debug_spawner
{
    ...
    repeat _size
    {
        ...
        var _spawner_id = variable_struct_get(_category, "debug_spawner")
        if (_spawner_id != undefined && _spawner_id != pointer_null)
        {
            ...
            if (variable_struct_get(_category, "moddable_only") == true)
            {
