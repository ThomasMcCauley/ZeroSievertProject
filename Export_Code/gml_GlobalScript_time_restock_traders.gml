function time_restock_traders() //gml_Script_time_restock_traders
{
    with (obj_controller)
    {
        db_open("general")
        global.trader_money_all = 50000 * gml_Script_difficulty_get("trade_trader_money") * (global.sk_k[(22 << 0)])
