...
*/
function inventory_sync_armor_durability() //gml_Script_inventory_sync_armor_durability
{
    ...
    repeat array_length(_loot_array)
    {
        ...
        if loot_in_armor_slot(_loot)
            _loot.durability = gml_Script_player_loadout_get_durability(player_get_local(), "armor slot")
        _i++
    }
}
