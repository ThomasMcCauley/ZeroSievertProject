...
*/
function db_version_older_than(argument0, argument1, argument2, argument3) //gml_Script_db_version_older_than
{
    ...
    if (is_string(_major) || is_string(_minor) || is_string(_patch))
        return false;
    return (_major < argument1 || (_major == argument1 && _minor < argument2) || (_major == argument1 && _minor == argument2 && _patch < argument3));
}
