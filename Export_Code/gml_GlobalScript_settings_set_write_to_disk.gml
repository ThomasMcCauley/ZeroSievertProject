...
*/
function settings_set_write_to_disk(argument0) //gml_Script_settings_set_write_to_disk
{
    global.__settings_write_to_disk = argument0
    db_set_save_on_close("local settings", argument0)
    db_set_save_on_close("shared settings", argument0)
    if global.__settings_write_to_disk
    {
        gml_Script_db_save_if_changed("local settings")
        gml_Script_db_save_if_changed("shared settings")
    }
}
