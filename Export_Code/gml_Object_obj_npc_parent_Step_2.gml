...
if (state == "human_chase_target" || state == "human_take_cover" || state == "human_go_to_bancone_hub" || state == "human_go_to_original_position" || human_state_now == (16 << 0) || human_state_now == (18 << 0) || human_state_now == (12 << 0) || human_state_now == (15 << 0))
{
    if (x != xprevious)
    {
