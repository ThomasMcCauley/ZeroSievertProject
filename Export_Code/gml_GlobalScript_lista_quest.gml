...
function lista_quest() //gml_Script_lista_quest
{
    ...
    repeat (1)
        ds_list_add(global.list_reward_quest[a], (19 << 0))
    a = (0 << 0)
    global.list_reward_quest[a] = ds_list_create()
    repeat (4)
        ds_list_add(global.list_reward_quest[a], (4 << 0))
    ...
    global.quest_obj_to_kill[a][0] = 304
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_kill(a, 0, 5, "Bandits", (1 << 0), ["bandit_boss", "bandit_boss_guard", "bandit_novice", "bandit_regular"])
    scr_quest_create_kill(a, 1, 5, -1, (1 << 0), ["wolf_brown"])
    a = (4 << 0)
    i = 0
    global.quest_id[a] = a
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_approach(a, 0, 984, 80, (1 << 0))
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_kill(a, 0, 15, -1, (1 << 0), ["wolf_brown"])
    a = (17 << 0)
    i = 0
    global.quest_id[a] = a
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_approach(a, 0, 985, 96, (3 << 0))
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_retrieve(a, 0, "quest_retrive_backpack_forest", 270, (1 << 0))
    global.quest_marker[a][0] = true
    global.quest_marker_sub[a][0] = 12
    global.quest_text_obj[a][0] = "Retrieve the equipment in the forest"
    scr_quest_create_retrieve(a, 1, "quest_retrive_backpack_makeshift_camp", 271, (2 << 0))
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_approach(a, 0, 978, 16, (2 << 0))
    global.quest_marker[a][0] = true
    ...
    scr_quest_create_kill(a, 1, 15, "Bandits", (2 << 0), ["bandit_boss", "bandit_boss_guard", "bandit_novice", "bandit_regular"])
    a = (25 << 0)
    i = 0
    global.quest_id[a] = a
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_approach(a, 0, 979, 16, (4 << 0))
    global.quest_marker[a][0] = true
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_contract(a, 0, 309, (4 << 0), "Unknown")
    a = (27 << 0)
    i = 0
    global.quest_id[a] = a
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_kill(a, 0, 15, -1, (6 << 0), ["killa"])
    a = (28 << 0)
    i = 0
    global.quest_id[a] = a
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_contract(a, 0, 837, (1 << 0), "Igor Kuzmin")
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_approach(a, 0, 980, 460, (1 << 0))
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_approach(a, 0, 981, 64, (1 << 0))
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_interact_with_obj(a, 0, 987, 32, "quest_dynamite", "Place dynamite", (32 << 0), (33 << 0))
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_place_marker(a, 0, 734, (2 << 0))
    global.quest_marker[a][0] = true
    global.quest_marker_sub[a][0] = 13
    ...
    scr_quest_create_kill(a, 0, 6, "Hunters", (2 << 0), ["loner_enemy", "loner_enemy_2"])
    a = (43 << 0)
    i = 0
    global.quest_id[a] = a
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_approach(a, 0, 982, 64, (2 << 0))
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_contract(a, 0, 311, (2 << 0), "Infestation")
    global.quest_marker[a][0] = true
    global.quest_marker_sub[a][0] = 3
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_retrieve_analyzer(a, 0, "quest_retrive_analyzer_forest", 274, (1 << 0))
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_approach(a, 0, 983, 40, (2 << 0))
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_interact_with_obj(a, 0, 749, 16, "repair_radio_tower", "Fix", (24 << 0), -1)
    ...
    global.quest_text[a][2] = quest_completed
    global.quest_text[a][3] = thank_for_help
    scr_quest_create_interact_with_obj(a, 0, 986, 10, "camera_crimson_quest", "Place camera", (34 << 0), -1)
    ...
    _quest_map[i][j] = [(1 << 0), (2 << 0), (3 << 0), (4 << 0), (6 << 0)]
    ...
    if (global.daily_quest_generated == false)
    {
            ...
            if (_create_new[i] == true)
            {
                ...
                for (j = 0; j < _n_objectives; j++)
                {
                    ...
                    while (_already_generated == true)
                    {
                        ...
                        var _array_chance2 = []
                        for (k = 0; k < _size_second_entry; k++)
                        {
                    ...
                    switch _quest_type_selected
                    {
                        case "kill":
                            ...
                            if (_quest_map[_index][_second_entry_index] == -1)
                            {
                                ...
                                {
                                    if scr_chance(50)
                                        var _choosed_quest_map = choose((1 << 0), (2 << 0))
                                    else
                        ...
                        case "collect":
                            ...
                            _diff_multiplier = 1 + _n_generated / 2
                        ...
                        case "contract":
                            ...
                            _diff_multiplier = 1 + _n_generated * 2 / 10
                            if (_quest_map[_index][_second_entry_index] == -1)
                            {
                                if (_user_lvl < 3)
                            ...
                            break
                        case "survive":
                            _diff_multiplier = 1 + _n_generated / 4
                            _choosed_quest_map = _quest_map[_index][_second_entry_index]
                            ...
                            break
                        case "survive_exp":
                            _diff_multiplier = (1 + _n_generated / 3) * (random_range(0.8, 1.2))
                            if (_quest_map[_index][_second_entry_index] != -1)
                            {
                                _array_map = _quest_map[_index][_second_entry_index]
                                _choosed_quest_map = _array_map[irandom(array_length(_array_map) - 1)]
                                if (_user_lvl < 3)
                                    _choosed_quest_map = choose((1 << 0), (2 << 0))
                            }
        ...
        for (i = (173 << 0); i <= (176 << 0); i++)
        {
            if (_create_new[i] == true)
            {
                db_write("Quest", (string(i) + "_daily_name"), ("Daily " + (string(i - (173 << 0) + 1))))
    ...
    {
        global.quest_id[a] = a
        global.quest_name[a] = db_read("Quest", (string(a) + "_daily_name"), ("Daily " + (string(a - (173 << 0)))))
    ...
    db_close()
    for (i = 0; i < (177 << 0); i++)
        global.quest_reward[i] = round(global.quest_reward[i] * gml_Script_difficulty_get("pro_quest_money"))
}
