...
visible = true
if (!(player_local_state_is(gml_Script_scr_player_state_pda, gml_Script_scr_player_state_inventory)))
{
    draw_self()
    if player_local_state_is(gml_Script_scr_player_state_move)
    {
        ...
        var _mult = glance_effective_range(gml_Script_player_loadout_get_ammo_item(_player, _player.weapon_slot_now), _player.arma_now, point_distance(_player.x, _player.y, x, y), true)
    ...
    if player_local_state_is(gml_Script_scr_player_state_dead)
        image_index = 4
}
