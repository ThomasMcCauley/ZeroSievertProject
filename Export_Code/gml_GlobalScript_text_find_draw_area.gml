function text_find_draw_area(argument0, argument1, argument2) //gml_Script_text_find_draw_area
{
    var _text_width = string_width(argument2)
    var _text_height = string_height(argument2)
