function scr_quest_create_contract(argument0, argument1, argument2, argument3, argument4) //gml_Script_scr_quest_create_contract
{
    ...
    global.quest_contract_obj_name[_quest_id][i] = argument4
}
