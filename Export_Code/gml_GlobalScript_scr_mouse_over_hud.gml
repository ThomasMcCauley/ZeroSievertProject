...
*/
function scr_mouse_over_hud(argument0, argument1, argument2, argument3) //gml_Script_scr_mouse_over_hud
{
    if gml_Script___uiGlobal().__defaultOnion.gml_Script___uiGlobal().__defaultOnion.HasInputReceiver()
        return false;
    return (obj_cursor.x >= argument0 && obj_cursor.x <= (argument0 + argument2) && obj_cursor.y >= argument1 && obj_cursor.y < (argument1 + argument3));
}
