...
if (obj_gamepad.action[(28 << 0)].value || (!(!obj_gamepad.last_input_keyboard)))
{
...
else if instance_exists(player_get_local())
{
    ...
    goto_x = _player.x + (lengthdir_x(_dist, obj_gamepad.input_decimal[(27 << 0)]))
    goto_y = _player.y + (lengthdir_y(_dist, obj_gamepad.input_decimal[(27 << 0)]))
    draw_set_colour(c_green)
    ...
    draw_line(_player.x, _player.y, (_player.x + (lengthdir_x(100, ((obj_gamepad.input_decimal[(27 << 0)]) + aim_assist_radial_angle)))), (_player.y + (lengthdir_y(100, ((obj_gamepad.input_decimal[(27 << 0)]) + aim_assist_radial_angle)))))
    draw_line(_player.x, _player.y, (_player.x + (lengthdir_x(100, ((obj_gamepad.input_decimal[(27 << 0)]) - aim_assist_radial_angle)))), (_player.y + (lengthdir_y(100, ((obj_gamepad.input_decimal[(27 << 0)]) - aim_assist_radial_angle)))))
}
with (obj_npc_parent)
{
