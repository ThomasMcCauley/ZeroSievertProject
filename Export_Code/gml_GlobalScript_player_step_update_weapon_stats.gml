...
*/
function player_step_update_weapon_stats() //gml_Script_player_step_update_weapon_stats
{
    if (item_get_category(arma_now) == "weapon")
    {
        ...
        now_recoil = _result.recoil * ((100 + (item_ammo_get_recoil(gml_Script_player_loadout_get_ammo_item(self, weapon_slot_now)))) / 100)
        now_precision = _result.acc
        now_damage = _result.damage
        now_ergo = _result.ergo
        now_reload_time = _result.reload_time
    }
}
