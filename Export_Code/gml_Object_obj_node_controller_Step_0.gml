...
if keyboard_check_pressed(ord("Q"))
{
    ...
    with (obj_bt_line_parent)
    {
        ...
        var _num = collision_line_list(x, y, _x2, _y2, 106, true, true, _list_node_collision, false)
        if (_num == 2)
        {
...
if mouse_check_button_pressed(mb_right)
{
    ...
    {
        _id = instance_position(obj_cursor.aa_x, obj_cursor.aa_y, obj_bt_line)
        with (_id)
            instance_destroy()
    }
}
...
{
    _id = instance_position(obj_cursor.aa_x, obj_cursor.aa_y, obj_node_parent)
    over_node_id = _id
}
