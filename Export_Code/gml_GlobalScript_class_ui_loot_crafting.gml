...
*/
/*
WARNING: Recursive script decompilation (for member variable name resolution) failed for gml_Script_crafting_meet_requirements
...
*/
/*
WARNING: Recursive script decompilation (for asset type resolution) failed for gml_Script_crafting_meet_requirements
...
System.InvalidOperationException: Stack empty.
   ...
   at UndertaleModLib.Decompiler.Decompiler.DirectFunctionCall.DoTypePropagation(DecompileContext context, AssetIDType suggestedType) in D:\a\UndertaleModTool\UndertaleModTool\UndertaleModLib\Decompiler\Instructions\Decompiler.DirectFunctionCall.cs:line 139
*/
function class_ui_loot_crafting() constructor //gml_Script_class_ui_loot_crafting
{
    __fulfilled = false
    ...
    self.VariableBind("loot", function() //gml_Script_anon_class_ui_loot_crafting_gml_GlobalScript_class_ui_loot_crafting_1806_class_ui_loot_crafting_gml_GlobalScript_class_ui_loot_crafting
    {
        return __lootStruct;
    }
, function(argument0) //gml_Script_anon_class_ui_loot_crafting_gml_GlobalScript_class_ui_loot_crafting_1867_class_ui_loot_crafting_gml_GlobalScript_class_ui_loot_crafting
    {
        __lootStruct = argument0
        __fulfilled = gml_Script_crafting_meet_requirements(__lootStruct, true, false)
    ...
    self.CallbackSetButtonClick(function(argument0) //gml_Script_anon_class_ui_loot_crafting_gml_GlobalScript_class_ui_loot_crafting_2391_class_ui_loot_crafting_gml_GlobalScript_class_ui_loot_crafting
    {
        ui_crafting_requirements_populate(__lootStruct)
    }
)
    self.CallbackSet((12 << 0), function() //gml_Script_anon_class_ui_loot_crafting_gml_GlobalScript_class_ui_loot_crafting_2522_class_ui_loot_crafting_gml_GlobalScript_class_ui_loot_crafting
    {
        if (self.GetButton() || self.GetHover())
        {
            ...
            gml_Script_loot_draw(__lootStruct, __drawLeft, __drawTop, 0, 4, 8421504, alpha)
        else
            gml_Script_loot_draw(__lootStruct, __drawLeft, __drawTop, 0, 4, color, alpha)
