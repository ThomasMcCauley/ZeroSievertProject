...
*/
function UiMouseOverContext() //gml_Script_UiMouseOverContext
{
    var _ui = gml_Script_uiFind(gml_Script___uiRootStackTop(), "context menu")
    if (!is_struct(_ui))
        return false;
    ...
    for (var i = 0; i < _count; i++)
    {
        ...
        if _this_button._this_button.GetHover()
            return true;
    }
    return false;
}
